 ...
 */
public abstract class GameLifecycleManager {
  ...
  /** Sets the active game phase in the manager. This also starts the game phase!! */
  ...
  /** Cycles to the next phase as defined in the phase This also starts the game phase!! */
