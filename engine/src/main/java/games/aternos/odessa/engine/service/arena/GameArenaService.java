...
public class GameArenaService extends Service {
  ...
  public GameArenaService(
      GameApi gameApi, IoConfigurationService ioConfigurationService, String gameName) {
    super(gameApi);
    this.gameName = gameName;
    this.ioConfigurationService = ioConfigurationService;
    this.gameArenaIoConfiguration =
        new GameArenaIoConfiguration(this.ioConfigurationService, gameName);
  }
